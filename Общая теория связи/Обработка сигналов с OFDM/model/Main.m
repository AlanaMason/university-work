        ...
        for k = 1:Ruler.OneWorkerNumOneIterFrames(WorkerNum)
            % Передатчик
                ...
                % Отображение на модуляционные символы
                    Frame.TxModSymbols = Objs.Mapper.StepTx( ...
                        Frame.TxIntData);
                    Frame.TxDataPattern= Objs.OFDMPattern.Step(Frame.TxModSymbols);
            ...
            % Приёмник
                ...
                % символов
                    ...
                    Frame.EqualizedData=Objs.Equalizer.Step(Frame.RxModSymbols, InstChannelParams);
                % Демодуляция
                    Frame.RxIntData    = Objs.Mapper.StepRx( ...
                        Frame.EqualizedData, InstChannelParams);
