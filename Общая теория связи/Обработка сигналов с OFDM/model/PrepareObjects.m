...
% Функция инициализации объектов
    ...
    % Цикл инициализации объектов главного цикла
        for k = 1:Params.Common.NumWorkers
            ...
            Objs{k}.Encoder = ClassEncoder(Params, LogLanguage, Objs{k});
            
            Objs{k}.Interleaver = ClassInterleaver(Params, LogLanguage);
            Objs{k}.Mapper = ClassMapper(Params, LogLanguage, Objs{k});
            Objs{k}.OFDMPattern = ClassOFDMPattern(Params, LogLanguage, Objs{k});
            Objs{k}.Sig = ClassSig(Params, LogLanguage, Objs{k});
            Objs{k}.Channel = ClassChannel(Params, Objs{k}, LogLanguage);
            Objs{k}.Equalizer = ClassEqualizer(Params, LogLanguage, Objs{k});
