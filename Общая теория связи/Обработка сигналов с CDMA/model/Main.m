        ...
        for k = 1:Ruler.OneWorkerNumOneIterFrames(WorkerNum)
            % Передатчик
                ...
                % Отображение на модуляционные символы
                    Frame.TxModSymbolsData = Objs.Mapper.StepTx( ...
                        Frame.TxIntData);
                % Формирование OFDM сигнала

                    Frame.TxOFDMSignal = Objs.OFDM.StepTx( ...
                        Frame.TxModSymbolsData);

                    Frame.TxCDMASignal = Objs.CDMA.StepTx( ...
                        Frame.TxOFDMSignal);
            ...
            % Приёмник
                ...
                % символов
                    Frame.RxCDMASignal = Objs.Sig.StepRx(Frame.RxSignal);

                    Frame.RxOFDMSignal = Objs.CDMA.StepRx( ...
                        Frame.RxCDMASignal, InstChannelParams);

                    Frame.RxModSymbols = Objs.OFDM.StepRx( ...
                        Frame.RxOFDMSignal, InstChannelParams);
                % Демодуляция
